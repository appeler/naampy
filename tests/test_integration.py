...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mixed_names_df = pd.DataFrame({
            'name': ['yasmin', 'nabha', 'vivek', 'kiara']  # yasmin/vivek=electoral, nabha/kiara=likely ML
        })
    ...
    def test_electoral_with_ml_fallback(self):
        ...
        for name in ['nabha', 'kiara']:
            ...
            self.assertTrue(has_electoral or has_ml,
    ...
    def test_end_to_end_workflow(self):
        ...
        raw_data = pd.DataFrame({
            ...
            'full_name': ['Priya Sharma', 'Rahul Kumar', 'Unknown ModernName', 'Vivek Singh'],
    ...
    def test_data_quality_assessment(self):
        ...
        quality_metrics = {
            ...
            'coverage_rate': (found_in_electoral + ml_predictions) / max(1, total_names)
        }
        ...
        self.assertEqual(quality_metrics['short_names'], 1)  # One single-letter name in test data
    ...
    def test_mixed_dataset_behavior(self):
        ...
        for dataset in datasets:
            try:
                results[dataset] = in_rolls_fn_gender(test_names, 'name', dataset=dataset)
